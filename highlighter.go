// highlighter.go
// Назначение: Модуль синтаксической подсветки для поддерживаемых языков программирования.
// Содержит парсеры и лексеры для распознавания ключевых слов, типов, строк, комментариев,
// чисел и операторов в разных языках. Определяет стили отображения для различных типов токенов
// и преобразует исходный код в цветные сегменты для визуального выделения синтаксических конструкций.
