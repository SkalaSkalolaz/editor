//  brackets.go
// Назначение: Модуль для поиска и подсветки парных скобок в тексте редактора.
// Содержит логику определения открывающих/закрывающих скобок, поиска соответствующих пар
// и управления визуальным выделением скобок при наведении курсора.
