// canvas.go  
// Назначение: Система управления множественными канвасами (вкладками/файлами) редактора.
// Реализует создание, переключение, синхронизацию и сохранение отдельных рабочих областей,
// включая поддержку проектов GitHub и проверку несохраненных изменений.
