// github.go
// Назначение: Модуль для работы с GitHub репозиториями в редакторе.
// Содержит функциональность для загрузки проектов с GitHub, парсинга URL, извлечения архивов,
// инициализации git репозиториев, коммита и пуша изменений. Интегрирует локальное редактирование
// с удаленными репозиториями через GitHub API и git команды.
