// undo.go
// Назначение: Система отмены/повтора действий (undo/redo) и глобального поиска-замены.
// Реализует стек состояний редактора для отслеживания изменений и операции массовой замены текста.
